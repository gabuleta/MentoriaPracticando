const apiGatosimagenes = [
  [
    {
      id: "234",
      url: "https://cdn2.thecatapi.com/images/234.jpg",
      width: 604,
      height: 402,
    },
    {
      id: "2nh",
      url: "https://cdn2.thecatapi.com/images/2nh.jpg",
      width: 1024,
      height: 768,
    },
    {
    ...
    {
      id: "bee",
      url: "https://cdn2.thecatapi.com/images/bee.jpg",
      width: 500,
      height: 334,
    },
    {
      id: "co8",
      url: "https://cdn2.thecatapi.com/images/co8.jpg",
      width: 613,
      height: 619,
    },
    {
      id: "dhu",
      url: "https://cdn2.thecatapi.com/images/dhu.jpg",
      width: 1000,
      height: 667,
    },
    {
...
// console.log(contenedorGatos);

// const classNames = "prueba";
...
// insertAdjacentHTML
// contenedorGatos.insertAdjacentHTML("afterend", html);

// esto da error porque el elemento aun no existe en el HTML
// const sarasa = document.querySelector(".prueba");
// contenedorGatos.classList.add("clase2");
// html.classList.add("prueba3");

// sarasa.classList.add("prueba4");

// const newElement = document.createElement("div");
// newElement.textContent("Hola como estas");
// newElement.classList.add("nuevoElemento");
// contenedorGatos.appendChild(newElement);

// for (const gato of apiGatos) {
//   // ACA podemos hacer toda nuestra logica
//   // For OF hace un loop/iteracion por cada elemento de apiGatos

//   // guarda el nombre del gato
//   const nombreGato = gato.name;
...
//      <a href=${gato.wikipedia_url}>wikipedia</a>
//     </div>
//   `;

//   // insertalo en mi documento html
//   contenedorGatos.insertAdjacentHTML("afterbegin", html);
// }

// document.querySelector(".nombreGato").textContent = "Gatito";
// const nombreGato = document.querySelector(".nombreGato");

// nombreGato.textContent = apiGatos[0].name;

// usando los corchetes ([x]) accedo al elemento numero X de un array
//console.log(apiGatos[0]);
// usando el punto (.) accedemos a las propiedades de un objeto
//console.log(apiGatos[0].name);
// usando ${...} podemos insertar variables o contenido dinámico
//const pruebaIteracion = document.querySelector(".pruebaIteracion");
// pruebaIteracion.insertAdjacentHTML(
//   "afterbegin",
//   `<div class="card">
//     <img
//       src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgKjIIAa5VUz2OYDKsr76ZK--7QflKFky6ALi203AxFBo3Znvx3pTXGUrbuy-YjMM6q54&usqp=CAU"
//       class="card-img-top"
//       alt="..."
//     />

//     <div class="card-body">
//       <h5 class="card-title nombreGato">${apiGatos[0].name}</h5>
//       <p class="card-text">${apiGatos[0].description}</p>
//       <a href="${apiGatos[0].wikipedia_url}" class="btn btn-primary">Ir a su perfil</a>
//     </div>
//   </div>`
// );

// 1. iterar/loopear en el array apiGatos usando for...of
// const cadaGato of apiGatos ==> por cada iteracion de apiGatos, guardame cada elemento en la variable cadaGato
for (const cadaGato of apiGatos) {
  // 2. en cada iteracion, creamos una variable con un elemento HTML que sea una card de bootstrap
  console.log(cadaGato);
  // en la primera iteracion cadaGato = apiGatos[0]
  // en la segunda, cadaGato = apiGatos[1]...

  // imagen gato
  // 1. crear una variable con la URL con el reference_image_id de cada uno de nuestros gatos. ej. https://api.thecatapi.com/v1/images/0XYvRd7oD
  // ` se usan para crear un string e insertar variables dentro (con peso y llaves)

  const urlImagen = `https://api.thecatapi.com/v1/images/${cadaGato.reference_image_id}`;

  console.log(urlImagen);

  //
  const cardGatos = `<div class="card">
    <img
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgKjIIAa5VUz2OYDKsr76ZK--7QflKFky6ALi203AxFBo3Znvx3pTXGUrbuy-YjMM6q54&usqp=CAU"
      class="card-img-top"
      alt="..."
    ...
    <div class="card-body">
      <h5 class="card-title nombreGato">${cadaGato.name}</h5>
      <p class="card-text">${cadaGato.description}</p>
      <p>Inteligencia: ${cadaGato.intelligence}</p>
      <p>Puntaje: ${cadaGato.adaptability + cadaGato.affection_level}<p/>
      <a href="${
        cadaGato.wikipedia_url
      }" class="btn btn-primary color-boton botonirasuperfil">Ir a su perfil</a>
    </div>
  </div>`;

  //Acá agregué querySelector para que las ubique dentro del coso4 que tiene grids-cards
  // Usé beforeend para que se muestre alfabeticamente

  document
    .querySelector(".grid-cards")
    .insertAdjacentHTML("beforeend", cardGatos);

  // console.log(cardGatos);
}
// No se puede acceder a cadaGato afuera del for..in porque esta fuera de su scope
// console.log(cadaGato);
